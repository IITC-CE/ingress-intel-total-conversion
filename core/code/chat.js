...
window.chat.writeDataToHash = function(newData, storageHash, isPublicChannel, isOlderMsgs, isAscendingOrder) {
  ...
  $.each(newData.result, function(ind, json) {
    ...
    // format: timestamp, autogenerated, HTML message, nick, additional data (raw, plugin specific data...)
    storageHash.data[json[0]] = [json[1], auto, chat.renderMsg(msg, nick, time, team, msgToPlayer, systemNarrowcast, isPublic, isSecure, msgAlert), nick, { raw: json }];
