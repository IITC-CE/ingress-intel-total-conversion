...
var setup = function() {
  ...
  window.addPortalHighlighter('History: Scout controlled', window.plugin.portalHistory.scoutControlled);
  window.addPortalHighlighter('History: NOT Scout controlled', window.plugin.portalHistory.notScoutControlled);
